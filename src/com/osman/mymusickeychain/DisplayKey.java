...
public class DisplayKey extends Activity {
	...
	public void printKey(MusicKey myKey){
		TextView text = new TextView(this);
		text = (TextView)findViewById(R.id.key_name);
		text.append(" " + myKey.getTonic() + " " + myKey.getMode());
		text = (TextView)findViewById(R.id.key_scale);
		String[] scale = myKey.getScale();
